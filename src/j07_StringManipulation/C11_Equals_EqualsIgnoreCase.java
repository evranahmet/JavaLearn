...
public class C11_Equals_EqualsIgnoreCase {
    public static void main(String[] args) {
        ...
        String str3="Sema";//String pool (ayni referans degere tanimlama yapiyor->yani adres ayni oluyor)
        String str4="Sema";//String pool (ayni referans degere tanimlama yapiyor->yani adres ayni oluyor)
        String str5=new String("Sema");//String data type unique bir referans(adres) deger atiyor
