...
// parametre entry değil sadece key değer girilirse key map'de varsa siler ve silinen key value return eder yoksa null return eder
        ...
        System.out.println("hm.remove(\"Vatan\",\"yahut silistre\") = " + hm.remove("Vatan", "yahut silistre"));//false
        ...
        System.out.println("hm = " + hm);//{Saturn=200 Euro, Teknosa=333 Euro, Amazon=296 Euro, Vatan=111 Euro}
    }
}
