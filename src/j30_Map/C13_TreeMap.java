...
public class C13_TreeMap {
    public static void main(String[] args) {
        ...
        //tm.put(null,"hadi gel");//RTE->NullPointerException
        tm.put(104,"noruyon nislen");//key dublicate degil unique deger olmali key value update edildi
        System.out.println("tm = " + tm);//{101=ıkır zıkır, 102=ebik gabık, 103=vıddıdı vıddıdı, 104=noruyon nislen}
        ...
        System.out.println("tm1 hm convert sonrasi = " + tm1);//{Amazon=296 Euro, Apple=450 Euro, Media Markt=444 Euro, Saturn=200 Euro, Teknosa=333 Euro, Vatan=111 Euro}
        //TreeMap<String,String> tm2=hm;//CTE->dataType uyusmadi(MissMatch)
        ...
        System.out.println("tm descendingKeySet() sonrasi = " + tm);//{101=ıkır zıkır, 102=ebik gabık, 103=vıddıdı vıddıdı, 104=noruyon nislen}
