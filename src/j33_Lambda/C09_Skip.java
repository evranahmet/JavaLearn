...
// akıs n den daha az eleman içeriyorsa  skip(n) meth dan sonra boş akıs return eder.skip(n) ara işlemdir.
        ...
        printİlk2HaricSonHarfSirali(yemahhh);
    }

    private static void printİlk2HaricSonHarfSirali(List<String> yemahhh) {
        System.out.println("***Version 01***");
        yemahhh
                .stream()
                .sorted(Comparator.comparing(t->t.charAt(t.length()-1)))
                .skip(2)
                .forEach(SeedMethods::strYazdir);//trileçe bicibici tantuni büryan Welemen cacix kokereç güveç soğanlı arabAşı
