...
public class C08_Limit {
    public static void main(String[] args) {
        ...
        */
        ...
        printKarakterSayiEnBuyuk(yemahhh);
    ...
    private static void printKarakterSayiEnBuyuk(List<String> yemahhh) {
        System.out.println("***Version 01***");
        System.out.println(
                yemahhh
                        .stream()
                        .sorted(Comparator.comparing(String::length).reversed())
                        .limit(1));//java.util.stream.SliceOps$1@6108b2d7
        ...
        yemahhh
                ...
                .sorted(Comparator.comparing(String::length).reversed())
                .limit(1)
                .forEach(System.out::println);//bicibici
