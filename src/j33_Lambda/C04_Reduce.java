 ...
 */
        ...
        System.out.println("printElTopla(sayiList) = " + printElTopla(sayiList));//Optional[198]
...
//                        .reduce(SeedMethods::minBul)
    ...
    private static Optional<Integer> printElTopla(List<Integer> sayiList) {
        return sayiList
                ...
                .reduce(Integer::sum);//specific data old. icin app daha hizli calisir
    }
