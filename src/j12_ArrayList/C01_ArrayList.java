...
*/
        ...
        //List tanımlama ve deger atama
        ArrayList<Integer> sayiList=new ArrayList<>();//Integer type'inde bos bir list tanimlandi.
        System.out.println("sayiList.add(17) = " + sayiList.add(17));
        sayiList.add(43);
        sayiList.add(19);
        sayiList.add(33);
        sayiList.add(34);
        ...
        sayiList.add(35);
        sayiList.add(10);
        sayiList.add(10);//ayni eleman birden cok defa list e eklenebilir.
        System.out.println("sayiList = " + sayiList);//[17, 43, 19, 33, 34, 10, 35, 10, 10]

        //2.yol Arrays.asList(); methodu
        List<String> yemekList=new ArrayList<>(Arrays.asList("Kusleme","Iskender","Ali Nazik","Caciki","Baklavaki","Karnı Yarik"));
        System.out.println("yemekList = " + yemekList);//[Kusleme, Iskender, Ali Nazik, Caciki, Baklavaki, Karnı Yarik]

        //3. Yol List.of() methodu
        ArrayList<String> ulkeList=new ArrayList<>(List.of("Alamanya","Isvec","Danimarka","Belcika","Hollanda"));
        System.out.println("ulkeList = " + ulkeList);//[Alamanya, Isvec, Danimarka, Belcika, Hollanda]

        //4. Yol List print etme
